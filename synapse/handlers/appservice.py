...
class ApplicationServicesHandler:
    def __init__(self, hs: "HomeServer"):
        ...
        self._msc3202_device_lists_enabled = (
            hs.config.experimental.msc3202_device_lists_enabled
        )
    ...
    def notify_interested_services_ephemeral(
        ...
        if stream_key == "device_list_key" and not self._msc3202_device_lists_enabled:
            return
            ...
            for service in services:
                ...
                with (
                    ...
                    if stream_key == "receipt_key":
                        ...
                        users_whose_device_lists_changed = (
                            await self._get_device_list_changes(service, new_token)
                        )
